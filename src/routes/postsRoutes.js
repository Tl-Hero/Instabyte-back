...
import { listarPosts, postarNovoPost, uploadImagem, attNovoPost } from "../controllers/postsController.js"; // Importa funções para gerenciar posts do arquivo postsController.js
